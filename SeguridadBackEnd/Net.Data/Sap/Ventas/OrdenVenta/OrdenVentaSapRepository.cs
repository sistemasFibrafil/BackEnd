...
namespace Net.Data.Sap
{
    public class OrdenVentaSapRepository : RepositoryBase<OrdenVentaSapEntity>, IOrdenVentaSapRepository
    {
        ...
        const string SP_GET_LIST_SEGUIMIENTO_BY_FECHA = DB_ESQUEMA + "VEN_GetListOrdenVentaSeguimientoByFecha";
        const string SP_GET_LIST_SEGUIMIENTO_DETALLADO_BY_FECHA = DB_ESQUEMA + "VEN_GetListOrdenVentaSeguimientoDetalladoByFecha";
        ...
        public async Task<ResultadoTransaccionEntity<OrdenVentaSapByFechaEntity>> GetListOrdenVentaSeguimientoByFecha(FilterRequestEntity value)
        {
        ...
        public async Task<ResultadoTransaccionEntity<MemoryStream>> GetOrdenVentaSeguimientoExcelByFecha(FilterRequestEntity value)
        {
            ...
            try
            {
                using (SpreadsheetDocument document = SpreadsheetDocument.Create(ms, SpreadsheetDocumentType.Workbook))
                {
                    ...
                    var objectGetList = await GetListOrdenVentaSeguimientoByFecha(value);
        ...
        public async Task<ResultadoTransaccionEntity<MemoryStream>> GetOrdenVentaSeguimientoDetalladoExcelByFecha(FilterRequestEntity value)
        {
            var ms = new MemoryStream();
            ...
            try
            {
                using (SpreadsheetDocument document = SpreadsheetDocument.Create(ms, SpreadsheetDocumentType.Workbook))
                {
                    ...
                    var objectGetList = await GetListOrdenVentaSeguimientoDetalladoByFecha(value);
