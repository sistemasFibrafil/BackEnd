...
namespace Net.Data.Sap
{
    public class FacturaVentaSapRepository : RepositoryBase<FacturaVentaSapEntity>, IFacturaVentaSapRepository
    {
        ...
        const string SP_GET_LIST_VENTA_BY_FECHA_AND_SLPCODE = DB_ESQUEMA + "VEN_GetLitVentaByFechaAndSlpCode";
        ...
        const string SP_GET_LIST_FACTURA_VENTA_BY_FECHA = DB_ESQUEMA + "VEN_GetLitFacturaVentaByFecha";
        ...
        public async Task<ResultadoTransaccionEntity<VentaProyeccionSapByFechaEntity>> GetListVentaProyeccionByFecha(FilterRequestEntity value)
        {
            var response = new List<VentaProyeccionSapByFechaEntity>();
            var resultTransaccion = new ResultadoTransaccionEntity<VentaProyeccionSapByFechaEntity>();
        ...
        public async Task<ResultadoTransaccionEntity<FacturaVentaSapEntity>> GetListVentaResumenByFechaGrupo(FilterRequestEntity value)
        {
            var response = new FacturaVentaSapEntity();
            var resultTransaccion = new ResultadoTransaccionEntity<FacturaVentaSapEntity>();
        ...
        public async Task<ResultadoTransaccionEntity<MemoryStream>> GetVentaResumenExcelByFechaGrupo(FilterRequestEntity value)
        {
        ...
        public async Task<ResultadoTransaccionEntity<VentaSapByFechaSlpCodeEntity>> GetListVentaByFechaAndSlpCode(FilterRequestEntity value)
        {
            ...
            var resultTransaccion = new ResultadoTransaccionEntity<VentaSapByFechaSlpCodeEntity>();
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(_cnxSap))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(SP_GET_LIST_VENTA_BY_FECHA_AND_SLPCODE, conn))
                    {
                        ...
                        cmd.Parameters.Add(new SqlParameter("@SlpCode", value.Cod1));
                        cmd.Parameters.Add(new SqlParameter("@CardName", value.Text1));

                        using (var reader = await cmd.ExecuteReaderAsync())
                        {
                            response = (List<VentaSapByFechaSlpCodeEntity>)context.ConvertTo<VentaSapByFechaSlpCodeEntity>(reader);
                        }
                    }
        ...
        public async Task<ResultadoTransaccionEntity<MemoryStream>> GetVentaExcelByFechaAndSlpCode(FilterRequestEntity value)
        {
            var ms = new MemoryStream();
            ...
            try
            {
                using (SpreadsheetDocument document = SpreadsheetDocument.Create(ms, SpreadsheetDocumentType.Workbook))
                {
                    ...
                    var objectGet = await GetListVentaByFechaAndSlpCode(value);
        ...
        public async Task<ResultadoTransaccionEntity<FacturaVentaSapByFechaEntity>> GetListFacturaVentaByFecha(FilterRequestEntity value)
        {
            var response = new List<FacturaVentaSapByFechaEntity>();
            var resultTransaccion = new ResultadoTransaccionEntity<FacturaVentaSapByFechaEntity>();
        ...
        public async Task<ResultadoTransaccionEntity<MemoryStream>> GetFacturaVentaExcelByFecha(FilterRequestEntity value)
        {
            var ms = new MemoryStream();
            var resultTransaccion = new ResultadoTransaccionEntity<MemoryStream>();
            _metodoName = regex.Match(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.Name).Groups[1].Value.ToString();
            ...
            try
            {
                using (SpreadsheetDocument document = SpreadsheetDocument.Create(ms, SpreadsheetDocumentType.Workbook))
                {
                    ...
                    var objectGet = await GetListFacturaVentaByFecha(value);
