...
namespace Net.Data.Sap
{
    public class EmpleadoVentaSapRepository : RepositoryBase<EmpleadoVentaSapEntity>, IEmpleadoVentaSapRepository
    {
        ...
        const string SP_GET_LIST = DB_ESQUEMA + "GES_GetListEmpleadoVenta";
        const string SP_GET_ID = DB_ESQUEMA + "GES_GetEmpleadoVentaById";
        const string SP_GET_LIST_FILTRO = DB_ESQUEMA + "GES_GetListEmpleadoVentaByFiltro";
        ...
        public async Task<ResultadoTransaccionEntity<EmpleadoVentaSapEntity>> GetListByFiltro(FilterRequestEntity value)
        {
            var response = new List<EmpleadoVentaSapEntity>();
            var resultTransaccion = new ResultadoTransaccionEntity<EmpleadoVentaSapEntity>();
