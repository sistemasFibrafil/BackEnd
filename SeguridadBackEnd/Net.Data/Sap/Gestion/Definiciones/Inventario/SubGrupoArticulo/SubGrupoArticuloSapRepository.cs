...
namespace Net.Data.Sap
{
    public class SubGrupoArticuloSapRepository : RepositoryBase<SubGrupoArticuloSapEntity>, ISubGrupoArticuloSapRepository
    {
        ...
        const string SP_GET_LIST = DB_ESQUEMA + "GES_GetListSubGrupoArticulo";


        public SubGrupoArticuloSapRepository(IConnectionSQL context, IConfiguration configuration)
            : base(context)
        {
        ...
        {
            var response = new List<SubGrupoArticuloSapEntity>();
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(_cnxSap))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(SP_GET_LIST, conn))
                    {
                        ...
                        {
                            response = (List<SubGrupoArticuloSapEntity>)context.ConvertTo<SubGrupoArticuloSapEntity>(reader);
                        }
                    }
