...
namespace Net.Business.Services.Controllers.Sap.GestionBancos
{
    ...
    public class PagoRecibidoSapController : Controller
    {
        ...
        public async Task<IActionResult> GetListCobranzaCarteraVencidaByFechaCorte([FromQuery] FilterRequestDto value)
        {
            var objectGetList = await _repository.PagoRecibidoSap.GetListCobranzaCarteraVencidaByFechaCorte(value.ReturnValue());
        ...
        public async Task<IActionResult> GetListCobranzaCarteraVencidaExcelByFechaCorte([FromQuery] FilterRequestDto value)
        {
            try
            {
                var objectGetFile = await _repository.PagoRecibidoSap.GetListCobranzaCarteraVencidaExcelByFechaCorte(value.ReturnValue());
