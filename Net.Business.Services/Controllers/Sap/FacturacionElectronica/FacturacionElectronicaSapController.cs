...
namespace Net.Business.Services.Controllers.Sap.FacturacionElectronica
{
    ...
    public class FacturacionElectronicaSapController : Controller
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> GetListGuiaInternaElectronicaByFiltro([FromQuery] FilterRequestDto value)
        {
            var objectGetList = await _repository.FacturacionElectronicaSap.GetListGuiaInternaElectronicaByFiltro(value.ReturnValue());
        ...
        [ProducesResponseType(204)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> SendGuiaInternaElectronica([FromBody] FilterRequestDto value)
        {
            try
            {
                if (value == null)
                ...
                var response = await _repository.FacturacionElectronicaSap.SendGuiaInternaElectronica(value.ReturnValue());
