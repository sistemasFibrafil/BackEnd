...
namespace Net.Business.Services.Controllers.Sap.Gestion.Definiciones.General
{
    ...
    public class TipoOperacionSapController : Controller
    {
        private readonly IRepositoryWrapper _repository;
        public TipoOperacionSapController(IRepositoryWrapper repository)
        {
        ...
        {
            var objectGetList = await _repository.TipoOperacionSap.GetListByFiltro(value.ReturnValue());
