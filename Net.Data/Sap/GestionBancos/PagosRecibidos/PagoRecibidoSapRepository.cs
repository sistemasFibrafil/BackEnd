...
{
    public class PagoRecibidoSapRepository : RepositoryBase<PagoRecibidoSapEntity>, IPagoRecibidoSapRepository
    {
        ...
        const string SP_GET_LIST_COBRANZA_CARTERA_VENCIDA_BY_FECHA_CORTE = DB_ESQUEMA + "BAN_GetListCobranzaCarteraVencidaByFechaCorte";
        ...
        public async Task<ResultadoTransaccionEntity<CobranzaCarteraVencidaByFechaCorteSapEntity>> GetListCobranzaCarteraVencidaByFechaCorte(FilterRequestEntity value)
        {
            var response = new List<CobranzaCarteraVencidaByFechaCorteSapEntity>();
            var resultTransaccion = new ResultadoTransaccionEntity<CobranzaCarteraVencidaByFechaCorteSapEntity>();
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(_cnxSap))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(SP_GET_LIST_COBRANZA_CARTERA_VENCIDA_BY_FECHA_CORTE, conn))
                    {
                        ...
                        cmd.Parameters.Add(new SqlParameter("@FecCorte", value.Dat1));
                        cmd.Parameters.Add(new SqlParameter("@GroupCode", value.Cod1));
        ...
        public async Task<ResultadoTransaccionEntity<MemoryStream>> GetListCobranzaCarteraVencidaExcelByFechaCorte(FilterRequestEntity value)
        {
            ...
            try
            {
                using (SpreadsheetDocument document = SpreadsheetDocument.Create(ms, SpreadsheetDocumentType.Workbook))
                {
                    ...
                    var objectGetList = await GetListCobranzaCarteraVencidaByFechaCorte(value);
